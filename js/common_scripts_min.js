...
/* Search */
$(".search-overlay-menu-btn").on("click", function(a) { $(".search-overlay-menu").addClass("open"), $('.search-overlay-menu > form > input[type="search"]').focus() }), $(".search-overlay-close").on("click", function(a) { $(".search-overlay-menu").removeClass("open") }), $(".search-overlay-menu, .search-overlay-menu .search-overlay-close").on("click keyup", function(a) {
...
! function(t, i, e, s) {
    function o(i, e) {
        ...
        var a = this.$element.find(">.parallax-slider"),
            n = !1;
        0 == a.length ? this.$slider = t("<img />").prependTo(this.$mirror) : (this.$slider = a.prependTo(this.$mirror), n = !0), this.$mirror.addClass("parallax-mirror").css({ visibility: "hidden", zIndex: this.zIndex, position: "fixed", top: 0, left: 0, overflow: "hidden" }), typeof h.opacity !== s && this.$slider.css({ opacity: h.opacity }), typeof h.background !== s && this.$mirror.css({ backgroundColor: h.background }), this.$slider.addClass("parallax-slider").one("load", function() { h.naturalHeight && h.naturalWidth || (h.naturalHeight = this.naturalHeight || this.height || 1, h.naturalWidth = this.naturalWidth || this.width || 1), h.aspectRatio = h.naturalWidth / h.naturalHeight, o.isSetup || o.setup(), o.sliders.push(h), o.isFresh = !1, o.requestRender() }), n || (this.$slider[0].src = this.imageSrc), (this.naturalHeight && this.naturalWidth || this.$slider[0].complete || a.length > 0) && this.$slider.trigger("load")
    }
...
function(a) {
    ...
    b.Defaults = { nav: !1, navRewind: !0, navText: ["", ""], navSpeed: !1, navElement: "div", navContainer: !1, navContainerClass: "owl-nav", navClass: ["owl-prev", "owl-next"], slideBy: 1, dotClass: "owl-dot", dotsClass: "owl-dots", dots: !0, dotsEach: !1, dotData: !1, dotsSpeed: !1, dotsContainer: !1, controlsClass: "owl-controls" }, b.prototype.initialize = function() {
...
! function(a) {
    a.fn.animatedModal = function(o) {
        ...
        var e = a(this),
            i = a.extend({ modalTarget: "animatedModal", position: "fixed", width: "100%", height: "100%", top: "0px", left: "0px", zIndexIn: "9999", zIndexOut: "-9999", color: "#39BEB9", opacityIn: "1", opacityOut: "0", animatedIn: "zoomIn", animatedOut: "zoomOut", animationDuration: ".6s", overflow: "auto", beforeOpen: function() {}, afterOpen: function() {}, beforeClose: function() {}, afterClose: function() {} }, o),
...
! function(a) {
    a.fn.theiaStickySidebar = function(b) {
        ...
        function e(b, c) { return b.initialized === !0 || !(a("body").width() < b.minWidth) && (f(b, c), !0) }

        function f(b, c) {
            b.initialized = !0, a("head").append(a('<style>.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')), c.each(function() {
                function f() { c.fixedScrollTop = 0, c.sidebar.css({ "min-height": "1px" }), c.stickySidebar.css({ position: "static", width: "" }) }

                function g(b) { var c = b.height(); return b.children().each(function() { c = Math.max(c, a(this).height()) }), c }
                var c = {};
                c.sidebar = a(this), c.options = b || {}, c.container = a(c.options.containerSelector), 0 == c.container.size() && (c.container = c.sidebar.parent()), c.sidebar.parents().css("-webkit-transform", "none"), c.sidebar.css({ position: "relative", overflow: "visible", "-webkit-box-sizing": "border-box", "-moz-box-sizing": "border-box", "box-sizing": "border-box" }), c.stickySidebar = c.sidebar.find(".theiaStickySidebar"), 0 == c.stickySidebar.length && (c.sidebar.find("script").remove(), c.stickySidebar = a("<div>").addClass("theiaStickySidebar").append(c.sidebar.children()), c.sidebar.append(c.stickySidebar)), c.marginTop = parseInt(c.sidebar.css("margin-top")), c.marginBottom = parseInt(c.sidebar.css("margin-bottom")), c.paddingTop = parseInt(c.sidebar.css("padding-top")), c.paddingBottom = parseInt(c.sidebar.css("padding-bottom"));
                ...
                c.stickySidebar.css("padding-top", 1), c.stickySidebar.css("padding-bottom", 1), d -= c.stickySidebar.offset().top, e = c.stickySidebar.outerHeight() - e - d, 0 == d ? (c.stickySidebar.css("padding-top", 0), c.stickySidebarPaddingTop = 0) : c.stickySidebarPaddingTop = 1, 0 == e ? (c.stickySidebar.css("padding-bottom", 0), c.stickySidebarPaddingBottom = 0) : c.stickySidebarPaddingBottom = 1, c.previousScrollTop = null, c.fixedScrollTop = 0, f(), c.onScroll = function(c) {
                    if (c.stickySidebar.is(":visible")) {
                        ...
                        if (c.sidebar.outerWidth(!0) + 50 > c.container.width()) return void f();
                        var d = a(document).scrollTop(),
                            e = "static";
                        if (d >= c.container.offset().top + (c.paddingTop + c.marginTop - c.options.additionalMarginTop)) {
                            var m, h = c.paddingTop + c.marginTop + b.additionalMarginTop,
                                i = c.paddingBottom + c.marginBottom + b.additionalMarginBottom,
                                j = c.container.offset().top,
                                k = c.container.offset().top + g(c.container),
                                l = 0 + b.additionalMarginTop,
                                n = c.stickySidebar.outerHeight() + h + i < a(window).height();
                            m = n ? l + c.stickySidebar.outerHeight() : a(window).height() - c.marginBottom - c.paddingBottom - b.additionalMarginBottom;
                            var o = j - d + c.paddingTop + c.marginTop,
                                p = k - d - c.paddingBottom - c.marginBottom,
                                q = c.stickySidebar.offset().top - d,
                                r = c.previousScrollTop - d;
                            "fixed" == c.stickySidebar.css("position") && "modern" == c.options.sidebarBehavior && (q += r), "legacy" == c.options.sidebarBehavior && (q = m - c.stickySidebar.outerHeight(), q = Math.max(q, m - c.stickySidebar.outerHeight())), q = r > 0 ? Math.min(q, l) : Math.max(q, m - c.stickySidebar.outerHeight()), q = Math.max(q, o), q = Math.min(q, p - c.stickySidebar.outerHeight());
                            var s = c.container.height() == c.stickySidebar.outerHeight();
                            e = (s || q != l) && (s || q != m - c.stickySidebar.outerHeight()) ? d + q - c.sidebar.offset().top - c.paddingTop <= b.additionalMarginTop ? "static" : "absolute" : "fixed"
                        }
                        if ("fixed" == e) c.stickySidebar.css({ position: "fixed", width: c.sidebar.width(), top: q, left: c.sidebar.offset().left + parseInt(c.sidebar.css("padding-left")) });
                        else if ("absolute" == e) { var t = {}; "absolute" != c.stickySidebar.css("position") && (t.position = "absolute", t.top = d + q - c.sidebar.offset().top - c.stickySidebarPaddingTop - c.stickySidebarPaddingBottom), t.width = c.sidebar.width(), t.left = "", c.stickySidebar.css(t) } else "static" == e && f();
                        "static" != e && 1 == c.options.updateSidebarHeight && c.sidebar.css({ "min-height": c.stickySidebar.outerHeight() + c.stickySidebar.offset().top - c.sidebar.offset().top + c.paddingBottom }), c.previousScrollTop = d
                    }
                }, c.onScroll(c), a(document).scroll(function(a) { return function() { a.onScroll(a) } }(c)), a(window).resize(function(a) { return function() { a.stickySidebar.css({ position: "static" }), a.onScroll(a) } }(c))
            })
        }
        var c = { containerSelector: "", additionalMarginTop: 0, additionalMarginBottom: 0, updateSidebarHeight: !1, minWidth: 0, sidebarBehavior: "modern" };
...
function calc_BMR() {
    ...
    var b = "cm" == $("[name=height_select]").val() ? parseFloat($("[name=Height]").val()) : 12.7 * parseFloat($("[name=Height]").val()) / 5,
        c = parseFloat($("[name=Age]").val());
    return 0 >= b || 0 >= a || 0 >= c ? ($("#indicator").text("Please complete the form!"), $("#bmr_value").text(""), -1) : (a = $("input[name=Male]").prop("checked") ? 66 + 13.7 * a + 5 * b - 6.8 * c : 655 + 9.6 * a + 1.8 * b - 4.7 * c, 0 >= a ? ($("#bmr_value").text(""), $("#indicator").text("No kidding.Did you input the right value")) : ($("#bmr_value").text(a.toFixed(2)), $("#indicator").text("See your customized data below:")), a)
}

function calc_BMI() {
    var a = "kilo" == $("[name=weight_select]").val() ? parseFloat($("[name=Weight]").val()) : .45359237 * parseFloat($("[name=Weight]").val()),
        b = "cm" == $("[name=height_select]").val() ? parseFloat($("[name=Height]").val()) : 2.54 * parseFloat($("[name=Height]").val());
...
function calc_daily_calorie() {
    ...
    if (0 > a) $("#your_cal_intake").text("------");
        ...
        a *= b, $("#your_cal_intake").text(a.toFixed(2))
    }
}
...
function calc_easy_burned_unit(a, b) {
    ...
    for (d in b) {
        ...
        0 > e && (e = 0), $("input[name=" + d + "]").prop("checked") && (e = b[d] * e * a, $("#" + d + "_value").text(e.toFixed(2)), c += e)
    }
    return c
}
...
function calc_easy_burned() {
    var a = "kilo" == $("[name=weight_select]").val() ? parseFloat($("[name=Weight]").val()) : .45359237 * parseFloat($("[name=Weight]").val());
    if (0 > a) $("#indicator").text("Are you human bing? Are your in 3-D world?!"), $("#easy_cal_burned").text("------");
    else {
        var b = calc_easy_burned_unit(a, MET_DATA_LIA);
        $("#lia_total").text(b.toFixed(2));
        var c = calc_easy_burned_unit(a, MET_DATA_MIA);
        $("#mia_total").text(c.toFixed(2)), a = calc_easy_burned_unit(a, MET_DATA_VIA), $("#via_total").text(a.toFixed(2)), $("#easy_cal_burned").text((b + c + a).toFixed(2)), $("#indicator").text("See your customized data below:")
    }
}

function calc_adv_calculator() {
    var a = "kilo" == $("[name=weight_select]").val() ? parseFloat($("[name=Weight]").val()) : .45359237 * parseFloat($("[name=Weight]").val()),
        b = parseFloat($("[name=heartrate]").val()),
        c = parseFloat($("[name=Age]").val()),
        d = parseFloat($("[name=duration]").val());
...
var MET_DATA_LIA = { sleep: .9, watchtv: 1, destwork: 1.8, walking17: 2.3, walking25: 2.9 },
    MET_DATA_MIA = { bike50: 3, walking30: 3.3, home_exercise: 3.5, walking34: 3.6, bike10mph: 4, bike100: 5.5 },
    MET_DATA_VIA = { jogging: 7, calisthenics: 8, jogging_run: 8, rope_jump: 10 };
$(document).ready(function() { $("#selectBtn").bind("click", function() { calc_calories() }), $("input[name=Male]").prop("checked", !0), $("input[name=Female]").prop("checked", !1), $("input[name=Male]").bind("click", function() { $("input[name=Female]").prop("checked", !$(this).prop("checked")) }), $("input[name=Female]").bind("click", function() { $("input[name=Male]").prop("checked", !$(this).prop("checked")) }) });