...
$userheaders = "From: info@BiS-Fitness.com\n";
$usermessage = "Thank you for join to BiS-Fitness Newsletter!";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "Thank you <strong>$email_newsletter</strong>, your subscription has been submitted!!";
	echo "</div>";
